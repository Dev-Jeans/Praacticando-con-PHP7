<?php
// <!-- Ejercicio #1
// Crear una función en PHP que reciba "N parámetros" del tipo entero (...$parametros) y que retorne como respuesta el total de números impares encontrados. -->



function numberPair(...$numbers){
  $n = 0;
...
// echo numberPair(9,5,3,7,8); 

/*
2. Crear un algoritmo que encuentre todas las vocales del abecedario a partir de la siguiente oración (he omitido las tildes)
"Hoy es un dia excelente para programar, me siento listo para poner en practica mis conocimientos en PHP 7".

Lo que se espera de la función es que permita retornar un array que como indices tendra todas las vocales, y como valor de cada
...
/*
3. La universidad Anexsoft nos ha asignado crear un algoritmo para calcular el promedio del curso de PHP 7.
